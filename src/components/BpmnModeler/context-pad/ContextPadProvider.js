...
ContextPadProvider.prototype.getContextPadEntries = function (element) {
  ...
  if (is(businessObject, 'bpmn:FlowNode')) {
    ...
    if (!is(businessObject, 'bpmn:EndEvent') &&
      ...
      if (is(businessObject, 'bpmn:UserTask')) {
        ...
        if (sourceRef.length > 0) {
          ...
          assign(actions, {
            ...
            'append.InclusiveGateway': appendAction(
      ...
      if (is(businessObject, 'bpmn:ParallelGateway') || is(businessObject, 'bpmn:InclusiveGateway') || is(businessObject, 'bpmn:ExclusiveGateway')) {
        assign(actions, {
          'append.append-user-task': appendAction(
            'bpmn:UserTask',
            'bpmn-icon-user-task',
